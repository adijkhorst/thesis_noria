...
### output: layer with extra nodes and edges for directed network, in groningen_final_network_exploded_d'+str(MAX_DIST_NODES)+'.geojson
...
original_layer_path = layers_folder + "waterways_groningen_final.geojson"
new_layer_path = layers_folder + "groningen_final_network.geojson"
