### input: geojson with simplified waterlines, path in original_layer_path
### output: layer with extra nodes and edges for directed network, in delft_final_network_exploded_d'+str(MAX_DIST_NODES)+'.geojson
...
original_layer_path = layers_folder + "waterway_canal_delft_exploded_fewnodes.geojson"
new_layer_path = layers_folder + "delft_final_network.geojson"
