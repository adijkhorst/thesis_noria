...
polygon_layer_path = "C:/Users/Anne-Fleur/OneDrive - Noria/Documents - Noria Internship/Anne Fleur/1. Working Folder/3. GIS/Static model/Static Model Groningen Leeuwarden/waterpolygons_groningen_final.geojson"
def write_sharp_corners_file(polygon_layer_path, corners_layer_path):
    # Load layers
...
write_sharp_corners_file(polygon_layer_path, corners_layer_path)
