...
# n_nodes = [392, 464, 586, 732, 782, 976, 1166]#, 1458]
# dists = [150, 125, 100, 80, 75, 60, 50]#, 40]
...
# Bmax_div2 = 10 #for plot with 150, 125, 100, 75, 50 Delft
# Bmax_div2 = 9 #for plot with 100, 90 ... 60, 50, 40 Delft
# Bmax_div2 = 6 #because n=50 has Bmax = 1.2
...
# n = 308
    ...
    with open('runs_different_n/'+str(n)+'nodes.txt') as f:
    ...
    for index, n_compared in enumerate(compared_to): #308 is being compared
        ...
        with open('runs_different_n/'+str(n_compared)+'nodes.txt') as f:
