    ...
    for feature in nodes_layer.getFeatures():
        ...
        for feat in impact_factor_layer.getFeatures():
            if feat.geometry().contains(feature.geometry().asPoint()):
                impact_factor = 1#feat['impact_factor']
...
polygon_layer_path = layers_folder + "\\waterpolygons.geojson"
...
shore_layer_path = layers_folder + "\\shore_types.geojson"
water_vegetation_path = layers_folder + "\\water_vegetation.geojson"
corners_layer_path = layers_folder + "\\sharp_corners.geojson"
...
impact_factor_layer_path = layers_folder + "\\sensitive_area.geojson"
