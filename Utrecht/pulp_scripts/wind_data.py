...
added_directory = current_directory + "\\pulp_scripts"

def get_wind_directions(year):
    #wind_data_path = "C:\\Users\\jurva\\Noria\\Noria Internship - Documents\\Anne Fleur\\1. Working Folder\\3. GIS\\Network FCLM\\thesis_noria\\Utrecht\\pulp_scripts\\wind_data.txt"
    wind_data_path = added_directory + "\\wind_data.txt"
